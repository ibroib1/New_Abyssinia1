  ...
  <a href="logout.php">
    <button class="btn black-btn" id="registerBtn" onclick="register()">log-out</button>
          ...
          <div id="mobile-sidenav" class="mobile-links w3-highway-blue">
            ...
            <a href="1.php" onclick="toggleMobileNavigation()">Grade 9</a>
            <a href="2.php" onclick="toggleMobileNavigation()">Grade 10</a>
            <a href="3.php" onclick="toggleMobileNavigation()">Grade 11</a>
            <a href="4.php" onclick="toggleMobileNavigation()">Grade 12</a>
        ...
        <div class="cards w3-padding-large w3-margin-top">
            ...
            <div class="card w3-card-4">
              ...
              <footer class="w3-container" style="padding: 0">
                <a class="w3-button w3-indigo w3-hover-blue" style="width: 100%;" href="1.php">visit</a>
              </footer>
            </div>
            ...
            <div class="card w3-card-4 w3-round-large">
              ...
              <footer class="w3-container" style="padding: 0">
                <a class="w3-button w3-indigo w3-hover-blue" style="width: 100%;" href="2.php">visit</a>
              </footer>
            </div>
            ...
            <div class="card w3-card-4">
              ...
              <footer class="w3-container" style="padding: 0">
                <a class="w3-button w3-indigo w3-hover-blue" style="width: 100%;" href="3.php">visit</a>
              </footer>
            </div>
        </div>
      </div>
      ...
      <div class="careers container" id="careers">
        ...
        <div class="cards w3-padding-large w3-margin-top">
            ...
            <div class="card w3-card-4">
              ...
              <footer class="w3-container" style="padding: 0">
                <a class="w3-button w3-indigo w3-hover-blue" style="width: 100%;" href="4.php">visit</a>
              </footer>
            </div>
