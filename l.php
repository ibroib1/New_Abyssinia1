  ...
  <a href="logout.php">
    <button class="btn black-btn" id="registerBtn" onclick="register()">log-out</button>
          ...
          <div id="mobile-sidenav" class="mobile-links w3-highway-blue">
            ...
            <a href="#" onclick="toggleMobileNavigation()">maths</a>
            <a href="#contact" onclick="toggleMobileNavigation()">Chemistry </a>
            <a href="#about" onclick="toggleMobileNavigation()">Biology</a>
            <a href="#" onclick="toggleMobileNavigation()">Physics</a>
      ...
      <div class="careers container" id="careers">
        <h2 class="w3-center">Our  teachers</h2>
            ...
            <div class="card w3-card-4">
              ...
              <div class="content w3-container">
                <div class="card-text" style="padding-bottom: 20px;">
                  ...
                  <h1>all high  school maths teachers</h1>
              ...
              <footer class="w3-container" style="padding: 0">
                <a class="w3-button w3-indigo w3-hover-blue" style="width: 100%;" href="mathst.php">visit</a>
              </footer>
            </div>

            <div class="card w3-card-4 w3-round-large">
              <header class="w3-container w3-indigo">
                 <h3>Chemistry experts</h3>
              </header>
              ...
              <div class="content w3-container">
                ...
                <ul style="list-style-type: none;"></ul>
                 <h1>all hight school chemistry teachers </h1>
              ...
              <footer class="w3-container" style="padding: 0">
                <a class="w3-button w3-indigo w3-hover-blue" style="width: 100%;" href="chemot.php">visit</a>
              </footer>
            </div>

            <div class="card w3-card-4">
              <header class="w3-container w3-indigo">
                 <h3>Biology experts</h3>
              </header>
              ...
              <div class="content w3-container">
                ...
                <ul style="list-style-type: none;"></ul>
                  <h1>all hight school biology teachers</h1>
              ...
              <footer class="w3-container" style="padding: 0">
                <a class="w3-button w3-indigo w3-hover-blue" style="width: 100%;" href="biot.php">visit</a>
              </footer>
            </div>
        </div>
      </div>
            ...
            <div class="card w3-card-4">
              ...
              <div class="content w3-container">
                <div class="card-text" style="padding-bottom: 20px;">
                  ...
                  <ul style="list-style-type: none;"> </ul>
                    <h1>all hight school physics teachers</h1>
                     <ul style="list-style-type: none;"> </ul> 
                   </div>
              </div>
              <footer class="w3-container" style="padding: 0">
